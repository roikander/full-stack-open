...
#### 07-notebackend
Kyseessä on Nodella Express-kirjastoa apuna käyttäen luotu web-palvelin, jolla voi toteuttaa HTTP-pyyntöjä ja vastauksia. Sovelluksessa käytetään VSCoden REST client laajennusta ja sen tiedostoja palvelimen testaukseen. Sisältää myös kaksi itse määriteltyä middlewarea.
