...
const url = `mongodb+srv://roikander_db_user:${password}@cluster0.tiadrfo.mongodb.net/noteApp?appName=Cluster0`

mongoose.set('strictQuery', false)
// muodosta yhteys tietokantaan, parametrina tietokannan url ja yhteystapa ipv4 
mongoose.connect(url, { family: 4 })

// määrittelee minkälaisia dokumentteja tämä notes-kokoelma sisältää  
const noteSchema = new mongoose.Schema({
  content: String,
  important: Boolean,
})

// eka parametri 'Note' kertoo että talleta oliot notes-kokoelmaan
...
// Tallettaa metodilla save uuden muistiinpanon ja 
// lopuksi sammuttaa tietokantayhteyden.
